import EcoBandsTimeline, { type EcoBand } from '../EcoBandsTimeline';

export default function EcoBandsTimelineExample() {
  // Mock data based on the reward_penalty_windows.csv structure
  const mockEcoBands: EcoBand[] = [
  ...
  return (
    <EcoBandsTimeline 
      ecoBands={mockEcoBands}
      onCalculateOptimal={() => console.log('Calculate optimal clicked')}
    />
  );
}